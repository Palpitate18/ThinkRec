...
def main(
    ...
    if resume_from_checkpoint!="base_model":
        print(f"Loading fine-tuned weights for main model from: {resume_from_checkpoint}")
    ...
    if resume_from_checkpoint!="base_model":
        print(f"Loading fine-tuned weights for reference model from: {resume_from_checkpoint}")
        reference_model = PeftModel.from_pretrained(model_ref, resume_from_checkpoint)
    else: 
        print("Using base model as reference model (no fine-tuned weights)")
